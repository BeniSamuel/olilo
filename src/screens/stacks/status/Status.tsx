  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.description_container}>
        <Image source={require("../../../../assets/status/oli_icon_happy.png")} resizeMode="contain"/>
      ...
      <View style={styles.button_container}>
        ...
        <TouchableOpacity style={[styles.button, { backgroundColor: bg_colors.button_bg_inactive}]} onPress={() => navigation.navigate("Signin")}>
          <Text style={[styles.button_text, { color: bg_colors.button_bg_active}]}>SKIP</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
